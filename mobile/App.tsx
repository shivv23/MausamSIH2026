...
import type { Activity, Card, Lang, ScenarioKey, UserProfile } from './src/engine';
...
export default function App() {
  ...
  const hp = buildHomepage({ user: profile, cityKey: profile.city || 'pune', scenarioKey: scenario, hour: new Date().getHours(), lang });
    ...
    <SafeAreaProvider>
      ...
      {tab === 'home' && (
        <Home hp={hp} lang={lang} offline={scenario !== 'auto'}
          ...
          onRedoOnboarding={redoOnboarding} onRetry={() => setScenarioOverride('auto')} />
      )}
